...
```javascript
import uniform from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-uniform@v0.0.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/random-uniform/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/random-uniform/actions/workflows/test.yml?query=branch:main
