...
```javascript
import uniform from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-uniform@v0.1.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-uniform@v0.1.1-deno/mod.js';
```
